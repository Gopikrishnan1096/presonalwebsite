...
!function(a) {
    ...
    E.prototype._getColumnSize = function(b, c) {
        var d;
        return d = a.isFunction(this.columnWidth) ? this.columnWidth(b) : this.useSizer ? E._getOuterWidth(this.sizer) : this.columnWidth ? this.columnWidth : this.$items.length > 0 ? E._getOuterWidth(this.$items[0], !0) : b,
        0 === d && (d = b),
        d + c
    }
    ,
    ...
    E.prototype._getColumnSpan = function(a, b, c) {
        var d = a / b;
        return Math.abs(Math.round(d) - d) < this.columnThreshold && (d = Math.round(d)),
    ...
    E.prototype._getStylesForTransition = function(a) {
        ...
        return this.supported ? b[p] = E._getItemTransformString(a.point, a.scale) : (b.left = a.point.x,
        b.top = a.point.y),
        b
    }
    ,
    ...
    E.prototype._startItemAnimation = function(b, c, d, e) {
        function f(b) {
            ...
            g._removeTransitionReference(h),
            e())
        }
        var g = this
          , h = {
    ...
    E.prototype._processStyleQueue = function(b) {
        ...
        c.length > 0 && this.initialized && this.speed > 0 ? (this.isTransitioning = !0,
        this.supported ? this._whenCollectionDone(c, o, this._movementFinished) : this._whenAnimationsDone(this._movementFinished)) : b || g(this._layoutEnd, this),
    ...
    E.prototype._whenCollectionDone = function(b, c, d) {
        function e(b) {
            ...
            f++,
            f === g && (h._removeTransitionReference(i),
            d.call(h)))
        }
        var f = 0
          , g = b.length
    ...
    a.fn.shuffle = function(b) {
        ...
        return this.each(function() {
            var d = a(this)
              , e = d.data(u);
            e ? "string" == typeof b && e[b] && e[b].apply(e, c) : (e = new E(this,b),
            d.data(u, e))
        })
    }
    ,
